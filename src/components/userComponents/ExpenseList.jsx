                  ...
                  {transaction.map((tr) => {
                    return (
                      <tr>
                        ...
                        <td>{tr.status}</td>
                        <td><Link to={`/user/updateExpense/${tr._id}`} className='btn btn-simple btn-primary'>update</Link>
                          <button onClick={() => { deleteTransaction(tr._id) }} className='btn btn-simple btn-danger'>delete</button>
                        </td>
                      </tr>
                    )
                  })}
