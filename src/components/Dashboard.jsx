...
import { BarChart } from './userComponents/TransactionCharts';
      ...
      <div className="row">
        <div className="col-lg-8">
          <div className="card ">
            ...
            <div className="card-body ">
              <div id="chartHours" className="card-body bg-gradient-light"> 
              ...
              <div id="chartHours" className="ct-chart">
                ...
                {searchRes.map((dt) => {
                  return (
                    <div>
                      <b>{dt.title}</b>
                      <p>Title:{dt.category.categoryName}, Amount:{dt.amount}</p>
                      <br />
                    </div>
                  )
